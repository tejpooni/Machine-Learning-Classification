...
def enhancedFeatureExtractorDigit(datum):
    ...
    This feature extraction function includes:
    - Count of white and black pixels.
    - Count of black pixels on the border.
    - Count of black to white transitions.
    """
    features = basicFeatureExtractorDigit(datum)

    whitePixels, blackPixels, borderPixels, transitions = 0, 0, 0, 0
        ...
        for y in range(DIGIT_DATUM_HEIGHT):
            ...
            if pixel > 0:
                ...
                if x == 0 or x == DIGIT_DATUM_WIDTH - 1 or y == 0 or y == DIGIT_DATUM_HEIGHT - 1:
                    borderPixels += 1
                if x > 0 and datum.getPixel(x - 1, y) <= 0 or y > 0 and datum.getPixel(x, y - 1) <= 0:
                    transitions += 1
            else:
                whitePixels += 1

    features['whitePixels'] = whitePixels
    features['blackPixels'] = blackPixels
    features['borderPixels'] = borderPixels
