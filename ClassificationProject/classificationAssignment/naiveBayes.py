...
class NaiveBayesClassifier(classificationMethod.ClassificationMethod):
    ...
    def findHighOddsFeatures(self, label1, label2):
        ...
        for feat in self.features:
            featuresOdds[feat] = self.conditionalProb[(feat, label1)] / self.conditionalProb[(feat, label2)]
        return sorted(featuresOdds.items(), key=lambda item: item[1], reverse=True)[:100]
